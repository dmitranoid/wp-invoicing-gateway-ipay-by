...
function wpinv_process_ipayby_payment( $purchase_data ) {
    ...
    */
    ...
    $payment_data = array(
		...
		'returnUrl'		=> wpinv_get_ipn_url( 'ipayby' ),
		'description'	=> 'оплата услуги на сайте '. site_url(),
